...
//            }, 100);
        ...
        $scope.changeVariation = function(){
            ...
            NBDDataFactory.get('nbdesigner_get_product_info', {product_id: NBDESIGNCONFIG['product_id'], variation_id: nbds_frontend.variation_product_id, need_templates: 1}, function(data){
                console.log(nbds_frontend.variation_product_id);
                $scope.toggleStageLoading();
                $scope.onloadVariation = false;
...
//                    dataObj.qtys = $scope.resource.config.qtys;
                    ...
                    $timeout(function(){
                        ...
                        if( NBDESIGNCONFIG.task == 'create' || ( NBDESIGNCONFIG.task == 'edit' && NBDESIGNCONFIG.design_type == 'template' )  ){
                            console.log($scope.customTemplate);
                            ...
                            console.log($scope.customTemplate.name);
                        ...
                        NBDDataFactory.get(action, dataObj, function(data){
                            ...
                            if(data.flag == 'success'){
                                ...
                                if( type == 'saveforlater' ){
                                    ...
                                    if(NBDESIGNCONFIG['admin_url_template'] != "") {
            ...
            if(angular.element($event.target).hasClass('stage')){
                ...
                if( $scope.settings.nbdesigner_save_latest_design == 'yes' ){
                    ...
                    $scope.localStore.update(pid, json, function(){
                        return  jQuery('.nbd-toasts').each(function () {
...
//                                }
            ...
            if( local ){
                ...
                NBDDataFactory.get('nbdesigner_get_product_info', {product_id: NBDESIGNCONFIG['product_id'], variation_id: NBDESIGNCONFIG['variation_id'] > 0 ? nbds_frontend.variation_product_id : NBDESIGNCONFIG['product_id'], template_id: temp.id}, function(data){
                    data = JSON.parse(data);
...
//            });
        ...
        $scope.forceForeground = function( item ){
            if( angular.isDefined( $scope.settings.nbes_enable_settings ) ){
                ...
                } else if( $scope.settings.nbes_enable_settings.foreground == 1 ){
                    foreFill = true;
...
//            width: $scope.stages[$scope.currentStage]['canvas'].width * 0.9,
        ...
        /* Image */
        $scope.addImage = function(url, showLoading, hideLoading, additionalTitle, additionalValue, maskId ){
            var stage = $scope.stages[$scope.currentStage],
                _canvas = stage['canvas'],
                scale = stage.states.scaleRange[stage.states.currentScaleIndex].ratio;
